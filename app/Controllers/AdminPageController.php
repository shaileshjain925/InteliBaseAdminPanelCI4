...
class AdminPageController extends BaseController
{
    ...
    public function export_item_import_template()
    {
        $ec = new ExcelController();
        $ss = $ec->createSpreadsheet();
        $im = $ec->setActiveSheet($ss, 0);
        $im->setTitle('ItemImport');
        $ec->addSheet($ss, 'Masters');
        ...
        $ItemClassDataValidation->setShowErrorMessage(true);

        // Optional: Set a title and an error message for invalid selections
        $ItemClassDataValidation->setErrorTitle('Invalid Selection');
        $ItemClassDataValidation->setError('Please select a valid option from the dropdown.');
        ...
        $ItemNatureDataValidation->setShowErrorMessage(true);

        // Optional: Set a title and an error message for invalid selections
        $ItemNatureDataValidation->setErrorTitle('Invalid Selection');
        $ItemNatureDataValidation->setError('Please select a valid option from the dropdown.');
        ...
        $ItemManufacturingTypeDataValidation->setShowErrorMessage(true);

        // Optional: Set a title and an error message for invalid selections
        $ItemManufacturingTypeDataValidation->setErrorTitle('Invalid Selection');
        $ItemManufacturingTypeDataValidation->setError('Please select a valid option from the dropdown.');
