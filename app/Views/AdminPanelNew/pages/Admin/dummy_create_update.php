  ...
  <div class="p-3" style="background: #fffceb;">
      <div class="offcanvas-header">
          <div class="">
              <h5 id="Add_outdoor_mediaLabel">Add dummy</h5>
              <p class="new_form_p">Please fill the form to add dummy</p>
          </div>
      </div>
          ...
          <form class="custom-validation " action="#">
              <div class="row">
                  <div class="mb-3 col-md-4">
                      ...
                      <p class="new_form_p">Please add dummy Name</p>
                      <input type="text" class="form-control" required placeholder="" />
                  </div>
                  <div class="mb-3 col-md-4">
                      <label class="form-label">Email</label>
                      <p class="new_form_p">Please add dummy Email</p>
                      <input type="text" class="form-control" required placeholder="" />
                  </div>
                  <div class="mb-3 col-md-4">
                  ...
                  <div class="mb-3 col-md-6">
                      ...
                      <p class="new_form_p">Please Select dummy Date</p>
                  ...
                  <div class="mb-3 col-md-12">
                      ...
                      <p class="new_form_p">Please add dummy Description</p>
                      <input type="text" class="form-control" required placeholder="" />
                  </div>
