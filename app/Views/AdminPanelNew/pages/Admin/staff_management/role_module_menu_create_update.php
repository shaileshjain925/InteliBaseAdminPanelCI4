...
<form>
    <div class="table-responsive">
        <table id="modules_table" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="dashboard[<?= $key ?>]" <?= $module['dashboard'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_view[<?= $key ?>]" <?= $module['master_view'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_create[<?= $key ?>]" <?= $module['master_create'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_edit[<?= $key ?>]" <?= $module['master_edit'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_approval[<?= $key ?>]" <?= $module['master_approval'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_delete[<?= $key ?>]" <?= $module['master_delete'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_print[<?= $key ?>]" <?= $module['master_print'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_export[<?= $key ?>]" <?= $module['master_export'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="master_bulk_delete[<?= $key ?>]" <?= $module['master_bulk_delete'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_view[<?= $key ?>]" <?= $module['transaction_view'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_create[<?= $key ?>]" <?= $module['transaction_create'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_edit[<?= $key ?>]" <?= $module['transaction_edit'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_approval[<?= $key ?>]" <?= $module['transaction_approval'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_delete[<?= $key ?>]" <?= $module['transaction_delete'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_print[<?= $key ?>]" <?= $module['transaction_print'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_export[<?= $key ?>]" <?= $module['transaction_export'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="transaction_bulk_delete[<?= $key ?>]" <?= $module['transaction_bulk_delete'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="report_view[<?= $key ?>]" <?= $module['report_view'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="report_print[<?= $key ?>]" <?= $module['report_print'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="report_export[<?= $key ?>]" <?= $module['report_export'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input text-center" name="config_view[<?= $key ?>]" <?= $module['config_view'] ? 'checked' : '' ?>>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
