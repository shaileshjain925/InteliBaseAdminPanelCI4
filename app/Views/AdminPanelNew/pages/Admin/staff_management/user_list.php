                ...
                <table id="table" class="table table-striped table-bordered dt-responsive nowrap table-nowrap align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Hot</td>
                            <td>
                                <a href="<?= base_url(route_to($user_type.'_create_update_page')) ?>" class="btn edit_btn edit" title="Edit">
                                    <i class="bx bx-edit-alt"></i>
                                </a>
                                <a onclick="view()" class="btn edit_btn edit" title="View" type="button" data-bs-toggle="offcanvas" data-bs-target="#right_floating_div" aria-controls="right_floating_div">
