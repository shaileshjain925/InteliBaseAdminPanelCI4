    ...
    <div class="card">
        <div class="card-body p-2">
            <div class="d-flex justify-content-end align-items-center mb-2">
                ...
                <?php if (check_menu_access('CITIES', 'create')): ?>
            ...
            <div class="table-responsive">
                <table id="city_table" class="table table-striped table-bordered dt-responsive nowrap table-nowrap align-middle w-100"></table>
            </div>
        </div>
    </div>
</div>
...
<script>
    var datatable_export = '<?= (check_menu_access('CITIES', 'export')) ?>';
    var datatable_print = '<?= (check_menu_access('CITIES', 'print')) ?>';
    var print_allowed = '<?= (check_menu_access('CITIES', 'print')) ?>';
