                    ...
                    <table id="modules_table" class="table align-middle table-hover table-bordered">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th><i style="font-size: x-large;" class="fa fa-eye" title="View Permission"></i></th>
                                <th><i style="font-size: x-large;" class="bx bx-plus me-2" title="Create Permission"></i></th>
                                <th><i style="font-size: x-large;" class="bx bx-edit-alt" title="Edit Permission"></i></th>
                                ...
                                <th><i style="font-size: x-large;" class="bx bx-trash-alt" title="Delete Permission"></i></th>
                                <th><i style="font-size: x-large;" class="mdi mdi-printer" title="Print Permission"></i></th>
                                <th><i style="font-size: x-large;" class="mdi mdi-file-excel" title="Export Permission"></i></th>
