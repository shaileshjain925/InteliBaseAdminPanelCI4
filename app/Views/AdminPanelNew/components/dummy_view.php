<div class="offcanvas-header pb-0">
    <div class="">
        <h5 id="Add_New_clientLabel">View dummy</h5>
        <p class="new_form_p">Please fill the form to View dummy</p>
    </div>
