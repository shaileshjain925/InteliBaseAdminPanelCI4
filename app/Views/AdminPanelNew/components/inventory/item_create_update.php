...
<div class="offcanvas-header">
    <div class="">
        <h5 id="Add_outdoor_mediaLabel"><?= isset($item_id) ? "Update" : "Create" ?> Item</h5>
    </div>
...
<div class="offcanvas-body">
    <form id="item-form" method="post" enctype="multipart/form-data" action="<?= isset($item_id) ? base_url(route_to('item_update_api')) : base_url(route_to('item_create_api')) ?>">
        ...
        <input type="hidden" name="item_user_id" value="<?= (isset($user_id)) ? $user_id : $_SESSION['user_id'] ?>">
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input type="file" name="item_box_image_upload" id="item_box_image_upload" class="form-control mt-2" onchange="uploadImage('item_box_image_upload','item','item_box_image','item_box_image_display')">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input type="file" name="item_image_upload" id="item_image_upload" class="form-control mt-2" onchange="uploadImage('item_image_upload','item','item_image','item_image_display')">
