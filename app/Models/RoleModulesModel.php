...
class RoleModulesModel extends FunctionModel
{
    ...
    public function __construct($joinRequired = true)
    {
        ...
        if ($joinRequired) {
            ...
            $this->addParentJoin('module_id', $this->get_modules_model(), 'left', ['module_name', 'module_code', 'is_dashboard']);
        }
    }
}
